...
/* Dead Chicken: our asset package carries 3048 object masks (780288B of mask
   data) - the upstream 2048 truncates the read and misaligns the trailing
   checksum ("Object.bin File Crashed"). */
constexpr auto MAX_OBJECT_MASK = 3048;
